/*
    Copyright 2009,2012-2016 Stéphane De Mita, Mathieu Siol
...
namespace egglib {
    ...
    extern const unsigned long int BEFORE; ///< Value before the first (large value)
    ...
    */
    class EggNonHierarchicalStructure : public EggException {
        ...
        public:
            ...
            /// Creates the exception
            EggNonHierarchicalStructure(bool indiv_flag, unsigned int label);

            /// Creates the exception (for individual in both ingroup/outgroup
            EggNonHierarchicalStructure(unsigned int label);
